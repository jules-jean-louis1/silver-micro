...
type ProfileFormProps = {
    setSuccessProfile: (value: boolean) => void;
  };

export const ProfileForm = ({ setSuccessProfile}: ProfileFormProps) => {
    ...
    return (
        <>
            <div>
                {data ? (
                    <form action="" method="put" onSubmit={handleSubmit} className="h-full">
